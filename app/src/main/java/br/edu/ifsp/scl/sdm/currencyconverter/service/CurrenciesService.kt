...
import br.edu.ifsp.scl.sdm.currencyconverter.model.domain.Symbol
...
class CurrenciesService: Service() {
  ...
  private inner class CurrenciesServiceHandler(looper: Looper): Handler(looper) {
    ...
    override fun handleMessage(msg: Message) {
      ...
      Log.d("DEBUG", "Service de moedas rodando")

      val symbols = mapOf(
        "USD" to Symbol("Dólar", "USD"),
        "BRL" to Symbol("Real", "BRL"),
        "EUR" to Symbol("Euro", "EUR"),
        "JPY" to Symbol("Iene", "JPY"),
        "GBP" to Symbol("Libra", "GBP")
      )
      ...
      Log.d("DEBUG", "Enviando moedas: $symbols")
